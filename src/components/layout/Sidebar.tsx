...
const as9100Items = [
  { path: '/as9100-compliance', label: 'AS9100 Compliance', icon: ShieldCheck },
];
    ...
    <aside className="mes-sidebar h-screen flex flex-col">
      ...
      <div className="p-6 border-b border-sidebar-border">
        <div className="flex flex-col gap-2">
          ...
          />
          <span className="text-xs text-destructive font-medium whitespace-nowrap text-center w-full">
